...
const services = [
  {
    ...
    description: 'Startups, scale-ups, grands groupes : accédez à l\'écosystème barcelonais.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Networking',
    description: 'Rencontres avec entrepreneurs, investisseurs et experts de la French Tech.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Hébergement',
    description: 'Hôtels, résidences étudiantes ou appartements sélectionnés.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Transport',
    description: 'Transferts, autocars, coordination de tous les déplacements.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Restauration',
    description: 'Expériences culinaires catalanes, tapas, restaurants sélectionnés.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Conférences inspirantes et ateliers pratiques avec des experts.',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-text-dark mb-4">
            On s'occupe de
            <span className="text-rusker-travel"> tout</span>
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            De l'organisation logistique aux rencontres stratégiques, votre seule mission : vivre l'expérience.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-bold text-text-dark mb-2 group-hover:text-rusker-travel transition-colors">
                {service.title}
              </h3>
