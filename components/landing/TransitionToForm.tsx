...
export default function TransitionToForm() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-rusker-blue py-20 md:py-32">
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center">
        ...
        >
          <Button
            ...
            variant="primary"
            size="large"
                className="bg-white text-gray-900 hover:bg-yellow-50 shadow-lg hover:shadow-xl transition-all duration-300 font-semibold"
          >
        ...
        >
          {stepHighlights.map((item, index) => (
              ...
              key={item.title}
                ...
                className="rounded-card border-2 border-white/40 bg-white/95 backdrop-blur-md p-6 text-left shadow-lg hover:shadow-xl hover:bg-white transition-all duration-300 hover:border-white/60"
            >
                <div className="mb-3 text-sm font-semibold uppercase tracking-[0.3em] text-rusker-blue">
                Étape {index + 1}
              </div>
