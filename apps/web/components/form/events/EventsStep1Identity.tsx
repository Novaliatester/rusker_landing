...
import { EventsFormData, Identity } from '@/lib/formUtils'
import { fadeInUp, staggerContainer } from '@/lib/animations'
import { useI18n } from '@/lib/i18n'

interface EventsStep1IdentityProps {
...
export default function EventsStep1Identity({ 
  formData, 
  updateFormData, 
  onNext,
  accentColor 
}: EventsStep1IdentityProps) {
  const { t } = useI18n()
