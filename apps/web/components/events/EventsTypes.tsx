  ...
  const eventTypes = [
    {
      ...
      titleKey: 'events.eventTypes.corporate.title',
      subtitleKey: 'events.eventTypes.corporate.subtitle',
      descriptionKey: 'events.eventTypes.corporate.description',
      featuresKeys: ['events.eventTypes.corporate.features.0', 'events.eventTypes.corporate.features.1', 'events.eventTypes.corporate.features.2', 'events.eventTypes.corporate.features.3'],
      image: getAssetPath('/images/rusker-travel-events-network-0201.jpg'),
      ctaKey: 'events.eventTypes.corporate.cta',
      stats: { value: '50+', labelKey: 'events.eventTypes.corporate.statsLabel' },
    },
    {
      id: 'public' as const,
      titleKey: 'events.eventTypes.public.title',
      subtitleKey: 'events.eventTypes.public.subtitle',
      descriptionKey: 'events.eventTypes.public.description',
      featuresKeys: ['events.eventTypes.public.features.0', 'events.eventTypes.public.features.1', 'events.eventTypes.public.features.2', 'events.eventTypes.public.features.3'],
      image: getAssetPath('/images/ai-summit-0201.jpg'),
      ctaKey: 'events.eventTypes.public.cta',
      stats: { value: '1200+', labelKey: 'events.eventTypes.public.statsLabel' },
    },
  ]
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-text-dark mb-4">
            {t('events.eventTypes.headline')}
            <span className="text-rusker-events"> {t('events.eventTypes.headlineHighlight')}</span>
          </h2>
            ...
            >
              ...
              <div className="relative h-48 md:h-56 overflow-hidden">
                ...
                <div className="absolute bottom-4 right-4 text-right">
                  ...
                  <div className="text-xs text-white/80">{t(eventType.stats.labelKey)}</div>
                </div>
              </div>

              {/* Content */}
              <div className="p-6 md:p-8">
                <h3 className="text-2xl font-bold text-text-dark mb-3">{t(eventType.titleKey)}</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">{t(eventType.descriptionKey)}</p>

                {/* Features list */}
                <ul className="space-y-3 mb-8">
                  {eventType.featuresKeys.map((featureKey, idx) => (
