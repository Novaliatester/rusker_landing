...
export default function EventsTestimonial() {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-br from-[#0b5d56] via-[#094a44] to-[#042a27] overflow-hidden">
      {/* Background elements */}
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-4 left-4 right-4 flex justify-between">
                <div className="text-white">
                  ...
                  <div className="text-sm text-white/80">{t('testimonials.events.participants')}</div>
                </div>
                <div className="text-white text-right">
                  <div className="text-3xl font-bold">80+</div>
                  <div className="text-sm text-white/80">{t('testimonials.events.speakers')}</div>
                </div>
                <div className="text-white text-right">
                  <div className="text-3xl font-bold">3</div>
                  <div className="text-sm text-white/80">{t('testimonials.events.days')}</div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <div className="text-white font-semibold">{t('testimonials.events.authorName')}</div>
                <div className="text-white/60 text-sm">{t('testimonials.events.authorRole')}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                { label: t('testimonials.events.npsScore'), value: '72' },
                { label: t('testimonials.events.mediaCoverage'), value: '50+' },
                { label: t('testimonials.events.partnershipsCreated'), value: '200+' },
              ].map((stat, index) => (
